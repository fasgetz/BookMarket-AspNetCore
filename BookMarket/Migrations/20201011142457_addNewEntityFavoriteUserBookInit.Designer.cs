...
namespace BookMarket.Migrations
{
    ...
    [Migration("20201011142457_addNewEntityFavoriteUserBookInit")]
    partial class addNewEntityFavoriteUserBookInit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookMarket.Models.DataBase.visitUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookMarket.Models.DataBase.visitUser", b =>
                {
                    b.HasOne("BookMarket.Models.DataBase.Book", "book")
                        .WithMany("VisitsBook")
                        .HasForeignKey("IdBook")
